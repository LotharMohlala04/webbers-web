...
export default function Catalogue() {
  ...
  const subCategories = [
    ...
    { name: "Travel Bags", href: `${category}/travelbags` },
    { name: "Hip Bags", href: `${category}/hipbags` },
    { name: "Laptop Sleeves", href: `${category}/laptop` },
  ];
              ...
              <form className="mt-4 border-t border-gray-200">
                ...
                {style && (
                  <>
                    ...
                    >
                      {subCategories.map((category1) => (
                        <li key={category1.name}>
                          <a href={`${category1.href}`} className="block px-2 py-3">
                            {category1.name}
                          </a>
                        </li>
                      ))}
              ...
              <form className="hidden lg:block">
                ...
                {!style && (
                  ...
                  >
                    {subCategories.map((category1) => (
                      <li key={category1.name}>
                        <a href={`${category1.href}`}>{category1.name}</a>
                      </li>
                    ))}
                  </ul>
                )}
                ...
                {filteredProducts.map((product) => (
                  ...
                  >
                    <img
                      ...
                      src={product.productPageImage}
                      className="aspect-square w-full rounded-lg bg-gray-100 object-cover group-hover:opacity-75 group-hover:border-gray-200 group-hover:border-1"
                    />
